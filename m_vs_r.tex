% Created by tikzDevice version 0.12 on 2019-02-12 15:35:59
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (203.18,320.59) {\itshape Representation from street vendors};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (203.18,306.19) {\itshape and vendor associations};
\end{scope}
\begin{scope}

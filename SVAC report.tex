...
\textbf{High Court of Gujarat: No Protection to Vendors That Violate State Laws} %BA says heading isnt good. Fix!!!
...
\begin{itemize}
	...
	\item Of the TVCs formed, 20\% have complied with step 8, have a street vending plan based on which vending zones are to be earmarked (step 9). %BA says unclear
...
\addcontentsline{toc}{subsection}{Of the 2,382 Town Vending Committees Formed, 58\% Claim to Have Vendor Representation}
	...
	Nine states—Andhra Pradesh, Chandigarh, Gujarat, Goa, Madhya Pradesh, Maharashtra, Odisha, Rajasthan and Uttar Pradesh—have elected representatives.%BA says why isn't punjab part of this list? Also, all TVCs in these states?
...
%BA says be consistent on percent v symbol and spelt out v numerical values in the text of the table. For tables suggest we use numerical values and percent symbol throughout. BA says language is unclear about plan v vending zone demarcation and unclear if the percentages for this difference are exclusive or inclusiv
\footnotesize
...
\bf{Steps: 7/11}
&
\cellcolor{SVACyellow2}Arunachal Pradesh is one of the four states without rules in place. The delay in the implementation may be attributed to the process to repeal the Arunachal Pradesh Street Vendors Act, 2011. However, the repeal Act saves all orders and action taken under the 2011 Act indicating that the state had not progressed significantly under the previous Act. %BA says this is unclear
...
\begin{longtable}[l]{>{\raggedright}p{7cm}>{\raggedright\arraybackslash}p{7.5cm}}
  \caption{Implementation of the Street Vendors Act 2014 in Gurugram - at a Glance}\\
    ...
    \rowcolor{SVACgreen2} Local authority to form the TVC & The city has constituted one TVC in its one municipality (MCG) \\
      \rowcolor{SVACyellow2} TVC to conduct a survey of street vendors & Ongoing (more than 18,000+) \\ %BA says number needs an explanatory phrase like 49 zones earmarked
    \rowcolor{SVACyellow2} TVC to issue identity cards to street vendors & Ongoing (14000+) \\ %BA says number needs an explanatory phrase like 49 zones earmarked
...
\subsection*{Mandate of the Act v/s Mandate of the MCG: Only 14\% Vendor Representation in TVC, Instead of 40\%} %BA says unclear what you mean by mandate of MCG
\addcontentsline{toc}{subsection}{Mandate of the Act v/s Mandate of the MCG: Only 14\% Vendor Representation in TVC, Instead of 40\%} %BA says unclear what you mean by mandate of MCG
...
%\addcontentsline{toc}{section}{Questionnaire for SV Act Implementation}
...
\begin{figure}[h]
\centering
\includegraphics[width=5in]{Appendix6.pdf}
\end{figure}
...
%\addcontentsline{toc}{section}{Receipt of Maintenance Fee Paid by Vendors}
\begin{figure}[h]
\centering
...
%Appendix 7
\newpage
\section{Complaint Made By a Private Party to MCG against RWA}
\label{appendix: RWA complaint}

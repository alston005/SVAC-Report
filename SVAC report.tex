...
%Centre for Civil Society\\
%A69, Hauz Khas, New Delhi - 110016\\
%Phone: +91 11 26537456 \textbar \hspace{0.5em} Email: ccs@ccs.in \textbar \hspace{0.5em} Website: www.ccs.in\\


%Right to quote, share and publish is granted \\with due acknowledgement to Centre for Civil Society.\\ 

%ISBN No.: 978-81-87984-45-0\\



%\newpage

%========================TITLE PAGE=================================%BA says needs to be revised second ccs name needs to go
\begin{titlepage}
\begin{center}
\line(1,0){300}\\
[0.25in]
\huge{\bfseries \textcolor{CCSbrown} {Progress Report on Implementing the Street Vendors Act 2014}} \\
[0.5cm]
%\large{Subtitle} \\
...
%{\small ISBN No.: 978-81-87984-45-0} \\
